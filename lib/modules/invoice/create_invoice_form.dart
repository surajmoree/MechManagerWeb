...
import 'package:mech_manager/modules/invoice/invoice_details_page.dart';
  ...
  Widget build(BuildContext context) {
    return BlocListener<JobSheetBloc, JobSheetState>(
      listener: (context, state) {
        if (state.status == jobSheetStatus.invoiceSuccess) {
          Fluttertoast.showToast(
            toastLength: Toast.LENGTH_SHORT,
            msg: "Invocie added successfully",
            backgroundColor: successDarkColor,
          );
          context
              .read<JobSheetDetailsBloc>()
              .add(GetInvoiceByInvoice(id: state.currentInvoiceId.toString()));
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: ElevatedButton(
                                        ...
                                        Map<String, dynamic> formData = {
                                          "vehicle_number":
                                              vehicleNumberController.text
                                                  .toString(),
                                          "vehicle_name": vehicleNameController
                                              .text
                                              .toString(),
                                          "manufacturers":
                                              (manufacturerController == "")
                                    ...
                                    child: Text(
                                      isVisibleVehicleDetails ? 'Next' : 'Add',
                                      style: TextStyle(
                                        fontFamily: 'meck',
                                        fontSize: 14,
                                        color: blackColor,
