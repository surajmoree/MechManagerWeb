...
class InvoiceEditVehicle extends StatefulWidget {
  int? id;
  String? vehicleNumber;
  String? vehicleName;
  String? manufacturers;
  InvoiceEditVehicle({super.key,
      this.id,
      this.manufacturers,
      this.vehicleName,
      this.vehicleNumber});
  ...
  @override
  State<InvoiceEditVehicle> createState() => _InvoiceEditVehicleState();
}

class _InvoiceEditVehicleState extends State<InvoiceEditVehicle> {
    ...
    return BlocConsumer<JobSheetDetailsBloc, JobSheetDetailsState>(
      listener: (context, state) {
        if (state.status == JobSheetDetailsStatus.updated) {
          ...
          context.read<JobSheetDetailsBloc>().add(GetInvoiceByInvoice(
                          ...
                          onPressed: () {
                            ...
                            if (_formKey.currentState!.validate()) {
                              ...
                              context.read<JobSheetDetailsBloc>().add(
                                    UpdateVehicle(
                                        id: state.invoiceModel!.vehicleId.toString(),
                                        formData: formData));
                              // context.read<JobSheetDetailsBloc>().add(
                              //     UpdateVehicle(
