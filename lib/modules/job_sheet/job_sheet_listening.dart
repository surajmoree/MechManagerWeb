...
class _JobSheetListingState extends State<JobSheetListing>
  ...
  Widget build(BuildContext context) {
    ...
    return BaseLayout(
      ...
      {
         double containerWidth = constraints.maxWidth > 600 ? 300.0 : constraints.maxWidth * 0.6;
      double iconContainerWidth = constraints.maxWidth > 600 ? 40.0 : constraints.maxWidth * 0.1;
      double textSize = constraints.maxWidth > 600 ? screenHeight * 0.023 : screenHeight * 0.018;
  ...
  child: TextField(
    ...
    decoration: InputDecoration(
      ...
      hintText: 'Search by vehicle number and customer name',
      fillColor: lightGreyColor,
    ),
  ),
),
                          ...
                          child: PopupMenuButton<String>(
                            ...
                            icon: Row(
                              ...
                              children: [
                                ...
                                Text(
                                 selectedFilterValue.isEmpty ? "Filter by": selectedFilterValue,
                                  style: TextStyle(
                                    color: Colors.black87,
                                    fontWeight: FontWeight.w500,
                                  ),
                            ...
                            initialValue: selectedFilterValue.isNotEmpty? selectedFilterValue : "Filter by",
                            onSelected: (String value) {
                              setState(() {
                                   selectedFilterValue = value;
                              performFilterOperation(filterOption: selectedFilterValue);
                              });
